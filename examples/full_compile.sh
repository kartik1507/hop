/opt/riscv/bin/riscv32-unknown-elf-gcc -Wl,-Ttext,0x1000 -O2 $1.c -o $1.out
/opt/riscv/bin/riscv32-unknown-elf-objdump  -D --disassemble-zeroes --insn-width=4 $1.out > $1.out.dump
